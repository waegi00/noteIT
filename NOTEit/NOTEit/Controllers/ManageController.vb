...
Public Class ManageController
    ...
    Public Async Function Index(message As System.Nullable(Of ManageMessageId)) As Task(Of ActionResult)
        ViewData!StatusMessage = If(message = ManageMessageId.ChangePasswordSuccess, "Ihr Kennwort wurde geändert.", If(message = ManageMessageId.SetPasswordSuccess, "Ihr Kennwort wurde festgelegt.", If(message = ManageMessageId.SetTwoFactorSuccess, "Ihr Anbieter für zweistufige Authentifizierung wurde festgelegt.", If(message = ManageMessageId.[Error], "Fehler", If(message = ManageMessageId.AddPhoneSuccess, "Ihre Telefonnummer wurde hinzugefügt.", If(message = ManageMessageId.RemovePhoneSuccess, "Ihre Telefonnummer wurde entfernt.", ""))))))
    ...
    Public Async Function ManageLogins(message As System.Nullable(Of ManageMessageId)) As Task(Of ActionResult)
        ViewData!StatusMessage = If(message = ManageMessageId.RemoveLoginSuccess, "Die externe Anmeldung wurde entfernt.", If(message = ManageMessageId.[Error], "Fehler", ""))
        Dim userInfo = Await UserManager.FindByIdAsync(User.Identity.GetUserId())
